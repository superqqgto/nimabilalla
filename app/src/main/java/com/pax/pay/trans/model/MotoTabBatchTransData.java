 ...
 */
@DatabaseTable(tableName = "moto_tab_batch_trans_data")
public class MotoTabBatchTransData extends BaseTransData implements Serializable, Cloneable {
    private static final long serialVersionUID = 1L;

    public MotoTabBatchTransData() {//无参构造函数
    }

    public MotoTabBatchTransData(TransData transData) {
