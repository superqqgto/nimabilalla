...
public abstract class AbstractSlideExpandableListAdapter extends WrapperListAdapterImpl {
    ...
    private void notifyExpandCollapseListener(boolean isExpanding, View view, int position) {
    ...
    public void enableFor(View parent, int position) {
        ...
        if (more != null && itemToolbar != null) {
            ...
            //itemToolbar.requestLayout();  requested from animation
        }
    }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if (a != null && a.hasStarted() && !a.hasEnded()) {
                    ...
                    final boolean isExpanding = isExpanding(target);

                    // remember the state
                    openItems.set(position, isExpanding);
                    ...
                    notifyExpandCollapseListener(isExpanding, target, position);
                    animateView(target, isExpanding);
                }
            }
        });
    }

    private boolean isExpanding(final View view){
     ...
     * @param isExpanding   the animation type, either ExpandCollapseAnimation.COLLAPSE
     *               or ExpandCollapseAnimation.EXPAND
     */
    private void animateView(final View target, final boolean isExpanding) {
            ...
            public void onAnimationEnd(Animation animation) {
                if (isExpanding) {
                    if (parent instanceof ListView) {
                        ...
                        listView.smoothScrollToPosition(lastOpenPosition);
                    }
                }
